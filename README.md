...
## Draw the 2D 
![image](https://user-images.githubusercontent.com/75235159/168851823-ad9f6b0a-826f-43e6-95f6-75fdb47061c5.png)
...
grid1 = GridProblem(initial=(2,1), goal =(8,6) ,obstacles={(2,2),(3,3),(4,3),(5,2),(6,4),(7,4),(5,5),(6,6),(7,6)})
solution1 = astar_search(grid1)
path_states(solution1)
```

## OUTPUT:
![image](https://user-images.githubusercontent.com/75235159/168851711-6cc3dc64-f719-4fc9-bbe1-64a0cc9af79f.png)
